...
# ==================== 配置区 ====================
TOTAL_SPEED="10M"
CONCURRENCY=5                # 国内镜像+大文件，建议5并发（内存版安全值）
DURATION=32400
CONNECT_TIMEOUT=5
LOWEST_SPEED="200K"
SPEED_TIMEOUT=30
SLEEP_MIN_FLOAT=0.3
SLEEP_MAX_FLOAT=1.5
DOWNLOAD_DIR="/dev/shm/ai_traffic"
...
# 硬编码稳定 URL
TENCENT_FIXED=(
    "https://mirrors.cloud.tencent.com/ubuntu-releases/24.04/ubuntu-24.04.4-desktop-amd64.iso"
    "https://mirrors.cloud.tencent.com/ubuntu-releases/24.04/ubuntu-24.04.4-live-server-amd64.iso"
    "https://mirrors.cloud.tencent.com/ubuntu-releases/22.04/ubuntu-22.04.5-desktop-amd64.iso"
    "https://mirrors.cloud.tencent.com/ubuntu-releases/22.04/ubuntu-22.04.5-live-server-amd64.iso"
    "https://mirrors.cloud.tencent.com/ubuntu-releases/20.04/ubuntu-20.04.6-desktop-amd64.iso"
    ...
    "https://mirrors.cloud.tencent.com/rocky/9/isos/x86_64/Rocky-9-latest-x86_64-dvd.iso"
    "https://mirrors.cloud.tencent.com/rocky/8/isos/x86_64/Rocky-8-latest-x86_64-dvd1.iso"
...
# 动态获取 Debian current DVD ISO（文件名随版本变化）
...
echo " 主力: hf-mirror 公开大模型"
echo " 补充: 腾讯云镜像 + 网易镜像 ISO"
echo " URL总数：${#URL_LIST[@]} 条"
