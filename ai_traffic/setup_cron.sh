...
DAY_SCRIPT="/usr/local/bin/ai_traffic.day.sh"
NIGHT_SCRIPT="/usr/local/bin/ai_traffic.night.sh"
DAY_LOG="/usr/local/bin/ai_traffic.day.log"
NIGHT_LOG="/usr/local/bin/ai_traffic.night.log"
